...
namespace xilopro2.Migrations
{
    ...
    [Migration("20231121060556_fix2111")]
    partial class fix2111
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("CategoryIdentityUserCategoria", b =>
                {
                    b.Property<int>("CategoriesCategory_ID")
                        .HasColumnType("int");

                    b.Property<string>("IdentityUserCategoriasId")
                        .HasColumnType("nvarchar(450)");

                    b.HasKey("CategoriesCategory_ID", "IdentityUserCategoriasId");

                    b.HasIndex("IdentityUserCategoriasId");

                    b.ToTable("CategoryIdentityUserCategoria");
                });
            ...
            modelBuilder.Entity("xilopro2.Data.Entities.IdentityUserCategoria", b =>
                {
                    b.Property<string>("Id")
                        .HasColumnType("nvarchar(450)");
                    ...
                    b.ToTable("IdentityUserCategoria");
                });
            ...
            modelBuilder.Entity("CategoryIdentityUserCategoria", b =>
                {
                    b.HasOne("xilopro2.Data.Entities.Category", null)
                        .WithMany()
                        .HasForeignKey("CategoriesCategory_ID")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("xilopro2.Data.Entities.IdentityUserCategoria", null)
                        .WithMany()
                        .HasForeignKey("IdentityUserCategoriasId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
                });
            ...
            modelBuilder.Entity("xilopro2.Data.Entities.IdentityUserCategoria", b =>
                {
                    b.HasOne("xilopro2.Data.Entities.User", "User")
                        .WithMany("IdentityUserCategorias")
                        .HasForeignKey("UserId");
            ...
            modelBuilder.Entity("xilopro2.Data.Entities.User", b =>
                {
                    b.Navigation("IdentityUserCategorias");
