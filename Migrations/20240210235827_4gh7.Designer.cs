            ...
            modelBuilder.Entity("xilopro2.Data.Entities.Matchgame", b =>
                {
                    ...
                    b.HasIndex("LocalTeam_ID");

                    b.HasIndex("Player_ID");

                    b.HasIndex("UserId");

                    b.HasIndex("VisitorTeam_ID");
            ...
            modelBuilder.Entity("xilopro2.Data.Entities.Matchgame", b =>
                {
                    ...
                    b.HasOne("xilopro2.Data.Entities.Team", "Local")
                        .WithMany()
                        .HasForeignKey("LocalTeam_ID")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
                    ...
                    b.HasOne("xilopro2.Data.Entities.Team", "Visitor")
                        .WithMany()
                        .HasForeignKey("VisitorTeam_ID")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
