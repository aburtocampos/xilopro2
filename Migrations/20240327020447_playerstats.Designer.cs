...
namespace xilopro2.Migrations
{
    ...
    [Migration("20240327020447_playerstats")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("xilopro2.Data.Entities.Player", b =>
                {
                    ...
                    b.HasIndex("SelectedCategoryIds", "Player_Dorsal")
                        .IsUnique();
            ...
            modelBuilder.Entity("xilopro2.Data.Entities.PlayerStatistics", b =>
                {
                    ...
                    b.Property<int>("MatchgamesMatch_ID")
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("xilopro2.Data.Entities.Torneo", b =>
                {
                    ...
                    b.HasIndex("Torneo_Name", "SelectedCategoryIds")
                        .IsUnique();
            ...
            modelBuilder.Entity("xilopro2.Data.Entities.PlayerStatistics", b =>
                {
                    b.HasOne("xilopro2.Data.Entities.Matchgame", "Matchgames")
                        .WithMany("PlayerStats")
                        .HasForeignKey("MatchgamesMatch_ID")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
